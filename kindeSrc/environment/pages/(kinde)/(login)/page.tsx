...
type LoginPageProps = KindePageEvent & { widget: React.ReactNode };

const LoginPage: React.FC<LoginPageProps> = ({ context, request, widget }) => {
  const heading = context.widget.content.heading || 'Welcome back.';
...
export default async function Page(event: KindePageEvent): Promise<string> {
  ...
  const page = <LoginPage {...event} widget={widget} />;
