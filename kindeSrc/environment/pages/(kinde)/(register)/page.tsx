...
/**
 * Moxii Registration Page
 * Matches the Figma design for phone number registration
 */
const MoxiiRegisterPage = async ({request, context}) => {
  return (
      ...
      <body>
        <div className="moxii-container">
          ...
          <div className="moxii-content">
            <h1 className="moxii-title">Welcome, let's start with your mobile number.</h1>
            <p className="moxii-subtitle">Get started today!</p>
...
export default async function Page(event) {
  const page = await MoxiiRegisterPage({...event});
